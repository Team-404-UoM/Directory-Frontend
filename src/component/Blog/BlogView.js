...
<div id="main">
  <button class="openbtn" onclick={this.openNav}>Comment</button>
                ...
                <React.Fragment>
                    ...
                    <p style={{fontSize:'13px',textAlign:"center"}}><img src={pic2} alt="" style={{width:'30px',height:'30px',marginRight:'5px',marginTop:'-5px',marginLeft:'5px',borderRadius:'2px'}}/><strong>Anushka Praveen </strong><span style={{marginLeft:"40px"}}><strong>Created At: {moment(this.state.createtime).format('MMM DD ,YYYY')}</strong></span><span style={{marginLeft:"50px"}}><strong>Updated At: {moment(this.state.updatetime).format('MMM DD ,YYYY')}</strong></span></p>
                    <p><span className="categorie-area">Categorie | {this.state.categorie}</span></p>
