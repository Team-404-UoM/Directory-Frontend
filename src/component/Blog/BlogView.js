...
class BlogView extends Component {
    ...
    render() {
            return ( <
                    ...
                    <
                    div className = "col-4"
                    hidden = { this.state.show } > < /div> <
                    div className = "col-12" >
                    <
                    div className = "openbutton" >
                    <
                    box - icon onClick = { this.handleSidebar }
                    size = "lg"
                    name = "comment-detail" >
                    < /box-icon> <
                    div style = {
                        { marginTop: "-10px", marginLeft: "10px" } } > < span className = "badge rounded-pill bg-dark" > { this.state.comments.length } < /span></div >
                    ...
                    aria - label = "Close" >
                    < /button> { /* <h1>Comments</h1> */ } <
                    center >
                    <
                    textarea className = "comment-size"
                    placeholder = "Type comment here"
                    value = { this.state.comment }
                    onChange = { this.handleChange } > < /textarea> <
                    /center> <
                    div style = {
                        { color: 'red', fontSize: 12, marginLeft: '5%' } } > { this.state.commentvalidate } < /div> <
                    button className = "btn btn-primary comment-post-button"
                    ...
                    /button>  {
                        this.state.comments.map((comment) => (
                                    ...
                                    <
                                    img src = { `http://localhost:4000/images/${comment.userimage}` }
                                    alt = "blog-cover"
                                    style = {
                                        {
                                            width: "20px",
                                    ...
                                    /Card.Text> {
                                        ...
                                        (comment.firebaseId == this.context.UserDetails.firebaseUserId) && ( <
                                            ...
                                            name = 'trash'
                                            onClick = {
                                                () => this.handledDeleteComment(comment._id) } > < /box-icon>)} <
                                            /Card.Body> <
                                            /Card>))} <
                                            /div>
                                            ...
                                            p style = {
                                                { fontSize: "13px", textAlign: "center" } } >
                                            <
                                            img src = { `http://localhost:4000/images/${this.state.userimage}` }
                                            alt = "blog-cover"
                                            style = {
                                                {
                                                    width: "30px",
                                            ...
                                            span style = {
                                                { marginLeft: "40px" } } >
                                            <
                                            box - icon className = 'mt-2 mr-2'
                                            name = "time"
                                            animation = "flashing"
                                            size = "xs" >
                                            < /box-icon> <
                                            strong >
                                            Created At: { " " } { moment(this.state.createtime).format("MMM DD ,YYYY") } <
                                            /strong> <
                                            /span> <
                                            span style = {
                                                { marginLeft: "50px" } } >
                                            ...
                                            < /box-icon> <
                                            strong >
                                            Updated At: { " " } { moment(this.state.updatetime).format("MMM DD ,YYYY") } <
                                            /strong> <
                                            /span> <
                                            /p> <
                                            p >
                                            ...
                                            /span> <
                                            /p> <
                                            img src = { `http://localhost:4000/images/${this.state.coverImage}` }
                                            alt = "Cover"
                                            style = {
                                                {
