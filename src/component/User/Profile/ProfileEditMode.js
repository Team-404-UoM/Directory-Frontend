            ...
            <div className="col-5">
              ...
              <div className='mb-3'>
                ...
                <select className="mb-3">
                  ...
                  <option value="FE">Computational Mathematics Department</option>
              ...
              <div className='mb-3'>
                ...
                <br />
                <box-icon type='logo' name='facebook' border='square'></box-icon>
                <input type="email" className="form-field" /><br />
                <box-icon type='logo' name='twitter' border='square'></box-icon>
                <input type="email" className="form-field" /><br />
                <box-icon type='logo' name='instagram' border='square'></box-icon>
                <input type="email" className="form-field" /><br />
                <box-icon type='logo' name='linkedin' border='square'></box-icon>
                <input type="email" className="form-field" />
